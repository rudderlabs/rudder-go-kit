...
//
// Please note that numPartitions must be a power of 2 (e.g. 2, 4, 8, 16, ...), otherwise the distribution may not be uniform and could lead to unexpected results, including panics.
//
