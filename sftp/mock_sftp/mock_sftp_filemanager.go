...
func (m *MockFileManager) Reset() error {
	m.ctrl.T.Helper()
...
func (mr *MockFileManagerMockRecorder) Reset() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Reset", reflect.TypeOf((*MockFileManager)(nil).Reset))
}
